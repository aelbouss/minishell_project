...
SRC = main.c parsing/garbage_collector.c parsing/making_list/token.c parsing/making_list/check_syntaxe.c \
	...
	expand/expand_redr.c parsing/making_list/delete_quotes.c parsing/signals.c herdoc_expand/expand_hed.c herdoc_expand/fcts_her.c execution/execution_utils.c \
	...
	parsing/final_garbage_collector.c envs/fg_split.c builtins/ft_unset.c execution/heredoc.c execution/operators.c\
	execution/execution.c builtins/ft_exit.c execution/execution_utils3.c execution/execution_utils4.c execution/execution_utils5.c\
